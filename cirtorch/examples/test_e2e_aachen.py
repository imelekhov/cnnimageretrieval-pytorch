...
# test options
parser.add_argument('--data-path', default='/data/datasets/Aachen-Day-Night')
...
def main():
    ...
    with open(osp.join(args.data_path, "image_pairs_day_night_" + str(args.top_n) + ".txt"), "w") as f:
